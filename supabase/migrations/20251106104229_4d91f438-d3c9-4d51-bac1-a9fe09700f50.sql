-- Stock Reconciliation with Negative Values Allowed
-- Step 1: Reset ALL stocks to zero
UPDATE products SET stock_quantity = 0;
UPDATE product_variants SET stock_quantity = 0;

-- Step 2: Calculate stock from purchases minus sales for ALL items (allowing negatives)
...
UPDATE products p
SET stock_quantity = la.quantity_change
