-- Fix JALANI PUDINA AAM PANNA 50GM stock discrepancy
-- Correct purchase from 288 to 48 units
...
-- Update the purchase total amount (recalculate based on corrected item)
UPDATE purchases
SET total_amount = (
