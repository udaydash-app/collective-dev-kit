-- Recalculate stock: Reset to 0, add today's purchases, subtract sales from Nov 3
UPDATE products SET stock_quantity = 0;

-- Add stock from today's purchases
...
-- Subtract all sales from Nov 3, 2025 onwards
WITH sales_items AS (
  SELECT 
