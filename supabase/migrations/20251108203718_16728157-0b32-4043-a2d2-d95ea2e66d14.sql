-- Fix the handle_pos_journal_entry trigger to properly delete old journal entries on UPDATE
...
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    -- Delete journal entries by reference (transaction number)
  ...
  -- Check if journal entry already exists (shouldn't happen after DELETE above)
