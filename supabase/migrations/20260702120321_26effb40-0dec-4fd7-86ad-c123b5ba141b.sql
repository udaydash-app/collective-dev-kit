...
DECLARE
  ...
  v_diff NUMERIC;
BEGIN
  -- Allow: service_role, or any signed-in user who is admin/cashier, or POS/offline calls via anon
...
GRANT EXECUTE ON FUNCTION public.generate_opening_balances(DATE) TO anon, authenticated, service_role;