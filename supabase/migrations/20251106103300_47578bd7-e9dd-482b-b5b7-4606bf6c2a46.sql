...
-- Corrected Stock Reconciliation: quantity_change is ABSOLUTE stock value, not delta
...
-- Step 3: Products WITH adjustments - use adjustment as absolute baseline stock, then apply transactions after
...
WITH latest_adjustments AS (
  SELECT DISTINCT ON (product_id)
    ...
    quantity_change as absolute_stock
...
UPDATE products p
SET stock_quantity = GREATEST(0,
  -- Start with the absolute stock value from adjustment
  la.absolute_stock
