-- Add transaction_amount column to journal_entries
ALTER TABLE journal_entries 
ADD COLUMN transaction_amount numeric;

-- Update handle_pos_journal_entry to store transaction amount
...
BEGIN
  ...
  -- Create journal entry with transaction_amount field
  INSERT INTO journal_entries (
    ...
    NEW.total,  -- Store actual transaction amount
    'posted',
    NEW.cashier_id,
    NEW.cashier_id,
    NOW()
